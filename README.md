Terraform Module for Redis Read-Write Splitting Through Tair Proxy

# terraform-alicloud-redis-read-write-splitting-tair-proxy

English | [简体中文](https://github.com/alibabacloud-automation/terraform-alicloud-redis-read-write-splitting-tair-proxy/blob/main/README-CN.md)

Terraform module which implements [Redis read-write splitting through Tair Proxy](https://www.aliyun.com/solution/tech-solution/read-write-splitting-through-tair-proxy) solution on Alibaba Cloud. This module creates a complete infrastructure including VPC, VSwitch, Security Group, ECS instance, and Redis (Tair) instance with read-write splitting capability. The solution enables automatic separation of read and write operations to improve Redis performance and scalability.

## Usage

To use this module to implement Redis read-write splitting through Tair Proxy:
...
* [Complete Example](https://github.com/alibabacloud-automation/terraform-alicloud-redis-read-write-splitting-tair-proxy/tree/main/examples/complete)
